						...
						<div class="info">
							<div class="row">
								<div class="col">
									<form action="">
										<p>아이디:
											<input type="text"	name="id" size="20" maxlength="15" />
										</p>
									</form>
								</div>	
								<div class="col">			
									<button type="button" id="submit" class="commentSubmit">중복확인</button>
								</div>
							</div>			
							<div class="row">
								<div class="col">
		...
		<section id="section3">
			<div class="container">
				<div class="go">
					<div class="row">
						<div class="col">
							<button type="button" id="submit" class="commentSubmit">회원가입</button>	
						</div>
						<div class="col">
							<button>취소</button>
						</div>
